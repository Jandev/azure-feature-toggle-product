...
- **SECTION_NAME** = [Human-readable name, e.g., "Authentication" or "Feature Toggle Dashboard"]
- **SECTION_ID** = [Folder name in sections/, e.g., "authentication" or "feature-toggle-dashboard"]
