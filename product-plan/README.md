# Azure Feature Toggle Tool — Design Handoff

This folder contains everything needed to implement the Azure Feature Toggle Tool.
...
- `instructions/incremental/` — Milestone-by-milestone instructions (foundation + 4 sections)
