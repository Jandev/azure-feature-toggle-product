...
import type { EnvironmentType, ConnectionTestResult } from '@/types';
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange('resourceName', e.target.value)}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange('resourceGroup', e.target.value)}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange('endpoint', e.target.value)}
              placeholder="https://your-appconfig.azconfig.io"
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Find this in the Azure Portal under your App Configuration resource (Overview → Endpoint)
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange('subscriptionId', e.target.value)}
              placeholder="12345678-1234-1234-1234-123456789abc"
              className={errors.subscriptionId ? 'border-red-500' : ''}
            />
            {errors.subscriptionId && (
              <p className="text-sm text-red-600 dark:text-red-400">{errors.subscriptionId}</p>
            )}
          </div>
