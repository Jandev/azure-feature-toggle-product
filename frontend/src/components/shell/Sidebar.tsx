...
export function Sidebar({ isCollapsed, activeSection, onNavigate }: SidebarProps) {
  return (
    <aside
      className={cn(
        'fixed left-0 top-16 bottom-0 bg-orange-50 dark:bg-slate-900 border-r border-stone-200 dark:border-stone-800 transition-all duration-300 ease-in-out z-40',
